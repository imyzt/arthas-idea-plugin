...
public class ArthasTerminalOptionsDialog extends JDialog {
    ...
    private void init(Project project, String command, Editor editor) {
        ...
        nameServerSelector.addItemListener(e -> loadAppSelector());
    ...
    private void loadAppSelector() {
        ...
        List<String> appIds = JSON.parseArray(resp).toJavaList(String.class).stream().sorted().collect(Collectors.toList());
